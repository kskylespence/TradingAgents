...
five-tier rating, download the report — without ever opening a terminal.

**Production topology (this fork):** one Coolify app + **local Postgres**
on the same VPS (or [Neon](https://neon.tech/) if you prefer managed
DB) + a persistent volume at `/data/tradingagents` for reports,
checkpoints, and the memory log. See [`DEPLOY.md`](DEPLOY.md) for the
full walk-through.
...
[`CHANGELOG.fork.md`](CHANGELOG.fork.md) (upstream changes remain in
[`CHANGELOG.md`](CHANGELOG.md)).

See [`web/README.md`](web/README.md) for the dev guide and full
documentation map.
