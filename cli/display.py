...
class AnalystWallTimeTracker:
    ...
    def get_wall_times(self) -> dict[str, float]:
        """Completed analysts' wall times in seconds, keyed by analyst key.

        Fork addition: the web backend reads these to emit
        ``analyst_wall_time`` events once a run finishes.
        """
